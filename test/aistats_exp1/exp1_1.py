...
for seed_datagen in range(100):
    ...
    # for high_covariance in ["R_small, Q_bigger", "R_bigger, Q_small", "R_bigger, Q_big"]:
    for high_covariance in ["R_bigger, Q_small", "R_bigger, Q_big"]:

        if high_covariance == "R_small, Q_bigger":
            theta_true = gen_dirchelet_params(d=d_true, noise_min_q=low, noise_max_q=high, N=N, Q_diag=False, R_diag=False, random_seed=seed_datagen) #[A, H, Q, R, m0, P0]
        elif high_covariance == "R_bigger, Q_small":
        ...
        elif high_covariance == "R_bigger, Q_big":
            theta_true = gen_dirchelet_params(d=d_true, N=N, noise_min_r=low, noise_max_r=high,
                                              noise_min_q=0.1, noise_max_q=1, Q_diag=False, R_diag=False, random_seed=seed_datagen) #[A, H, Q, R, m0, P0]
        elif high_covariance == "R_big, Q_bigger":
            theta_true = gen_dirchelet_params(d=d_true, N=N, noise_min_r=0.1, noise_max_r=1,
                                              noise_min_q=low, noise_max_q=high, Q_diag=False, R_diag=False, random_seed=seed_datagen) #[A, H, Q, R, m0, P0]
